...
class CSSGroup:
    ...
    def make_computed_h(self):
        ...
        t.append()
        t.append('/* CSS custom properties (--*) */')
        t.append('struct css_custom_property_map *custom_props;')
        t.append()
        t.append('/* Deferred var() bytecode - NULL if no var() to resolve, else array of entries */')
        t.append('struct css_deferred_var_list *deferred_vars;')
        t.append()
