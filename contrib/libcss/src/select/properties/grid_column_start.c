...
css_error css__cascade_grid_column_start(uint32_t opv,
					 css_style *style,
...
css_error css__copy_grid_column_start(const css_computed_style *from,
					 ...
					 css_computed_style *result)
{
	...
	return css__copy_grid_column_start(
