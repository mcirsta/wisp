...
## Macros
Wisp takes a strict stance on macro usage. Preprocessor macros should be entirely avoided, except:
...
This means that constants or what can be implemented using macros should always be done so as proper C code. Do note that some legacy Wisp code included in this repository contains complex macros.
